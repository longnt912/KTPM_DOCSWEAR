...
public class AddTest {
	...
	public void testAddtocartt(String Size, String Quantity, String Result) throws Exception {
		...
		DataSet++;
		driver.findElement(By.xpath("//div[@id='product__info']/div[4]/div/div/div/div[2]/a[2]")).click(); // chọn màu
		// DataSet++;
		driver.findElement(By.linkText(Size)).click(); // chọn size
		Thread.sleep(2000);
		driver.findElement(By.id("Quantity")).clear();
		driver.findElement(By.id("Quantity")).sendKeys(Quantity); // điền số lượng
		Thread.sleep(2000);
		driver.findElement(By.id("AddToCart")).click(); // thêm vào giỏ hàng
		Thread.sleep(2000);
